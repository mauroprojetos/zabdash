				...
				if($hosts['sd'] != 0) { 
					...
					<div class='hostdiv col-md-".$md." col-sm-".$md."' style='background-color:".$cor.";'>
						<table border='0' width='100%' height='100%' style='color:#fff;'>
							...
							<tr>
								<td>
								<div class=\"description nok" . $hostdivprio ."\"><i class=' ".$icon." icon" . $hostdivprio ."'></i> Timeout while connecting ".$hosts['name']."</div>
									".$IP['ip']."
								...
								<div class='hostdiv nok". $hostdivprio ." col-md-".$md." col-sm-".$md."'>
									<table border='0' width='100%' height='100%' style='color:#fff;' class='link". $hostdivprio ."'>
										<tr>										
											...
											<td rowspan='2'  width='22px' height='50%' >
												 <img src='img/os/".getOS($hosts['hostid']).".png' alt=''/>
											</td>										
										</tr>
										<tr>
											<td>";
															...
															foreach ($trigger as $event) {
																...
																// View
																echo "<div class=\"description nok" . $hostdivprio ."\"><i class=' ".$icon." icon" . $hostdivprio ."'></i> " . limitarTexto($description, $limite = 55). "</div>";
																//} else {
																break;
																//}		
															}							
